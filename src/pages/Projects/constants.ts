import areaSeca from "@/assets/area-seca.jpg";
import arbolSeco from "@/assets/arbol-seco.jpg";
import caseta from "/caseta/2.jpeg";

export const heroSection = {
  title: "Proyectos Misión Antigua",
  description:
    "Mantente al tanto de los proyectos del fraccionamiento y participa activamente en su mejora continua.",
};
...
export const projectsSection = [
  ...
  // {
  //   title: "Seguridad y participación comunitaria",
  //   description:
  ...
  // },
  // {
  //   title: "Infraestructura urbana y vialidades",
  //   description:
  ...
  // },
  // {
  //   title: "Automatización del portón principal",
  //   description:
  ...
  // },
  // {
  //   title: "Recuperación de árbol seco",
  //   description:
  ...
  // },
  // {
  //   title: "Rehabilitación de áreas verdes",
  //   description:
  ...
  // },
  // {
  //   title: "Renovación del área de juegos infantiles y área deportiva",
  //   description:
  ...
  // },
  // {
  //   title: "Actividades deportivas comunitarias",
  //   description:
  ...
  // },
  // {
  //   title: "Eventos de integración vecinal",
  //   description:
